...
const marks = [
    ...
    { value: 30000, label: '3000' },
    { value: 100000, label: '4000' },
    { value: 100001, label: '5000+' },
];

const getPlan = (users) => {
    if (users <= 10) return { label: 'Free 😎', details: ['up to 10 MAU'] };
    if (users <= 1000) return { label: '$100/mo', details: ['up to 1,0 MAU'] };
    if (users <= 5000) return { label: '$150/mo', details: ['up to 5,0 MAU'] };
    if (users <= 30000) return { label: '$200/mo', details: ['up to 30,0 MAU'] };
    if (users <= 100000) return { label: '$250/mo', details: ['up to 100,0 MAU'] };
    return { label: 'Contact Sales', details: ['Contact Sales 5000+ MAU'] };
};
        ...
        >
            <Container maxWidth="sm">
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        All subscription plans are based on the amount of monthly active users your app has. Every user that opens your app and uses Wearify features is counted as an active user for that month.
                    </AccordionDetails>
                </Accordion>
                <Accordion>
                    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                ...
                <Accordion>
                    <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                        Can I try Wearify SDK for free?
                    </AccordionSummary>
                    <AccordionDetails>
